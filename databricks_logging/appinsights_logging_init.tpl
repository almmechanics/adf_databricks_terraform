...
LOG_ANALYTICS_WORKSPACE_ID="${oms_id}"
LOG_ANALYTICS_PRIMARY_KEY="${oms_key}"

echo "BEGIN: Upload App Insights JARs"
cp -f "$STAGE_DIR/applicationinsights-core-${ai_version}.jar" /mnt/driver-daemon/jars || { echo "Error copying file"; exit 1;}
cp -f "$STAGE_DIR/applicationinsights-logging-log4j1_2-${ai_version}.jar" /mnt/driver-daemon/jars || { echo "Error copying file"; exit 1;}
